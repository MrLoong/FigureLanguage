...
class ViewController: UIViewController {
    ...
    var homeViewController : FDFeedViewController!
    ...
    override func viewDidLoad() {
        ...
        homeViewController = homeNavigationController.viewControllers.first as! FDFeedViewController
...
//        self.presentViewController(alertController, animated: true, completion: nil)
        self.homeViewController.performSegueWithIdentifier("sendMessage", sender: self);
